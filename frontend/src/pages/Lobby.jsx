      ...
      <div className="bg-gray-800 rounded-2xl shadow-2xl p-10 w-full max-w-md">
            ...
            {players.map((p) => (
              ...
              >
                ...
                <div className="ml-auto flex gap-2">
                  {p.isHost && (
                    <span className="text-xs bg-yellow-600
                                     text-white px-2 py-0.5 rounded-full">
                      Host
                    </span>
                  )}
                  {p.id === socket.id && (
                    <span className="text-xs bg-blue-600
                                     text-white px-2 py-0.5 rounded-full">
                      You
                    </span>
                  )}
        ...
        {isHost ? (
          ...
          <div className="text-center text-gray-400 py-2">
            <div className="inline-block w-4 h-4 border-2 border-gray-400
